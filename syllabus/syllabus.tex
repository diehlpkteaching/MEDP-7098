...
\item Nonlocal problem, like nonlocal diffusion or nonlocal continuum mechanics,
...
Table~\ref{tab:outline} indicates roughly how much time we will spend on each topic. There  is  a  full  lecture  calendar  available  in Table~\ref{tab:detailed:outiine}. There  is  also some flexibility in shortening some of these topics and adding other advanced topics. The chapters refer to the book ``Andrew, Koenig. Accelerated C++: practical programming by example. Pearson Education India, 2000'' which we will use for the brief  to C++.
...
\sfrac{1}{3} & Modern C++ implementation of computational problems \\
